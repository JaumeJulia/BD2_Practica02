...
$consultar_categorias_favoritas = '<a href="../BD243481084k/Categoria/mostrar_categoria_favorita.php?uname='.$usuario.'" class="button button4"style="font-size:20px" >Administrar Categorias Favoritas</a>';
