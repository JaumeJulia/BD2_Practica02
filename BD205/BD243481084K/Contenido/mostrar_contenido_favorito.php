...
<table class="center">
    <tr>
        ...
        <td><b><p style="color:black">Acciones</p></b></td>
    </tr>
<?php
    ...
    if($contenidoFavorito == false){
        ...
        ?>
            <tr>
                ...
                <td><form method="post" action="eliminar_contenido_favorito.php">
                                    <input type="hidden" name="video" value="<?php echo $reg['video'];?>">
                                    <center><button type="submit">Eliminar</button></center>
                                    </form></td>
            </tr>
